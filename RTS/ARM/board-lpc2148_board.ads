...
with LPC2148.Startup;
--  Used for include startup routines for LPC2148

package Board.LPC2148_Board is new LPC2148.Startup
  (Crystal_Frequency        =>  8_000_000,
   Desired_Frequency        => 60_000_000,
   Peripheral_Clock_Divider => 1);

pragma Preelaborate (Board.LPC2148_Board);
