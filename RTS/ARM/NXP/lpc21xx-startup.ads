...
--  Generic startup for LPC21XX family
...
package LPC21XX.Startup is
   ...
   pragma Warnings (Off, Enter_Idle);
   --  Suspend warning of same name for exported procedure Enter_Idle
   --  instantiated only one time
   pragma Export (Ada, Enter_Idle);
   pragma Warnings (On, Enter_Idle);
   --  Turn On warnings again
