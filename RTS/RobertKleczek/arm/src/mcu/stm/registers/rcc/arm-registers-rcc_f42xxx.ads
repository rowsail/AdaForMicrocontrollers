...
--                                                                            --
--               A R M . R e g i s t e r s . R C C _ F 4 2 X X X              --
--                                   S p e c                                  --
--                                                                            --
...
--------------------------------------------------------------------------------
--                           ARM.Registers.RCC_F42XXX                         --
--------------------------------------------------------------------------------

package ARM.Registers.RCC_F42XXX is
   ...
   package CR is
      ...
      type T is
         record
            PLLSAIRDY : CR.PLLSAIRDY.T;
            PLLSAION  : CR.PLLSAION .T;
      ...
      for T use
         record
            PLLSAIRDY at 0 range PLLSAIRDY.R'First .. PLLSAIRDY.R'Last;
            PLLSAION  at 0 range PLLSAION .R'First .. PLLSAION .R'Last;
   ...
   function PLLSAIRDY is new CR.FN.B (CR.PLLSAIRDY);
   function PLLSAION  is new CR.FN.B (CR.PLLSAION );
   ...
   function PLLSAI_Unlocked is new CR.FN.C (CR.PLLSAIRDY, 2#0#);
   function PLLSAI_Locked   is new CR.FN.C (CR.PLLSAIRDY, 2#1#);

   function PLLSAI_Off is new CR.FN.C (CR.PLLSAION, 2#0#);
   function PLLSAI_On  is new CR.FN.C (CR.PLLSAION, 2#1#);
   ...
   package CIR is
      ...
      for T use
         record
            ...
            PLLSAIRDYC  at 0 range PLLSAIRDYC .R'First .. PLLSAIRDYC .R'Last;
            ...
            PLLSAIRDYIE at 0 range PLLSAIRDYIE.R'First .. PLLSAIRDYIE.R'Last;
            ...
            PLLSAIRDYF  at 0 range PLLSAIRDYF .R'First .. PLLSAIRDYF .R'Last;
   ...
   function PLLSAIRDYC  is new CIR.FN.B (CIR.PLLSAIRDYC );
   ...
   function PLLSAIRDYIE is new CIR.FN.B (CIR.PLLSAIRDYIE);
   ...
   function PLLSAIRDYF  is new CIR.FN.B (CIR.PLLSAIRDYF );
   ...
   function Clear_Flag is new CIR.FN.C (CIR.PLLSAIRDYC, 2#1#);
   ...
   function Lock_Interrupt_Disabled is new CIR.FN.C (CIR.PLLSAIRDYIE, 2#0#);
   function Lock_Interrupt_Enabled  is new CIR.FN.C (CIR.PLLSAIRDYIE, 2#1#);
   ...
   function No_Clock_Security is new CIR.FN.C (CIR.PLLSAIRDYF, 2#0#);
   function Clock_Security    is new CIR.FN.C (CIR.PLLSAIRDYF, 2#1#);
   ...
   package AHB1RSTR is
      ...
      type T is
         record
            ...
            DMA2DRST  : AHB1RSTR .DMA2DRST . T;
            DMA2RST   : AHB1RSTR .DMA2RST  . T;
            DMA1RST   : AHB1RSTR .DMA1RST  . T;
            CRCRST    : AHB1RSTR .CRCRST   . T;
            GPIOKRST  : AHB1RSTR .GPIOKRST . T;
            GPIOJRST  : AHB1RSTR .GPIOJRST . T;
      ...
      for T use
         record
            ...
            DMA2DRST  at 0 range DMA2DRST .R'First .. DMA2DRST .R'Last;
            ...
            GPIOKRST  at 0 range GPIOKRST .R'First .. GPIOKRST .R'Last;
            GPIOJRST  at 0 range GPIOJRST .R'First .. GPIOJRST .R'Last;
   ...
   function DMA2dRST  is new AHB1RSTR.FN.B (AHB1RSTR.DMA2dRST );
   ...
   function GPIOKRST  is new AHB1RSTR.FN.B (AHB1RSTR.GPIOKRST);
   function GPIOJRST  is new AHB1RSTR.FN.B (AHB1RSTR.GPIOJRST);
   ...
   function Does_Not_Reset is new AHB1RSTR.FN.C (AHB1RSTR.DMA2DRST, 2#0#);
   function Resets         is new AHB1RSTR.FN.C (AHB1RSTR.DMA2DRST, 2#1#);
   ...
   function Does_Not_Reset is new AHB1RSTR.FN.C (AHB1RSTR.GPIOKRST, 2#0#);
   function Resets         is new AHB1RSTR.FN.C (AHB1RSTR.GPIOKRST, 2#1#);

   function Does_Not_Reset is new AHB1RSTR.FN.C (AHB1RSTR.GPIOJRST, 2#0#);
   function Resets         is new AHB1RSTR.FN.C (AHB1RSTR.GPIOJRST, 2#1#);
   ...
   package APB1RSTR is
      ...
      type T is
         record
            UART8RST : APB1RSTR.UART8RST.T;
            UART7RST : APB1RSTR.UART7RST.T;
      ...
      for T use
         record
            UART8RST at 0 range UART8RST.R'First .. UART8RST.R'Last;
            UART7RST at 0 range UART7RST.R'First .. UART7RST.R'Last;
   ...
   function UART8RST is new APB1RSTR.FN.B (APB1RSTR.UART8RST);
   function UART7RST is new APB1RSTR.FN.B (APB1RSTR.UART7RST);
   ...
   function Does_Not_Reset is new APB1RSTR.FN.C (APB1RSTR.UART8RST, 2#0#);
   function Resets         is new APB1RSTR.FN.C (APB1RSTR.UART8RST, 2#1#);

   function Does_Not_Reset is new APB1RSTR.FN.C (APB1RSTR.UART7RST, 2#0#);
   function Resets         is new APB1RSTR.FN.C (APB1RSTR.UART7RST, 2#1#);
   ...
   package APB2RSTR is
      ...
      type T is
         record
            LTDCRST   : APB2RSTR.LTDCRST  .T;
            SAI1RST   : APB2RSTR.SAI1RST  .T;
            SPI6RST   : APB2RSTR.SPI6RST  .T;
            SPI5RST   : APB2RSTR.SPI5RST  .T;
            TIM11RST  : APB2RSTR.TIM11RST .T;
            TIM10RST  : APB2RSTR.TIM10RST .T;
            TIM9RST   : APB2RSTR.TIM9RST  .T;
            SYSCFGRST : APB2RSTR.SYSCFGRST.T;
            SPI4RST   : APB2RSTR.SPI4RST  .T;
      ...
      for T use
         record
            LTDCRST   at 0 range LTDCRST  .R'First .. LTDCRST  .R'Last;
            SAI1RST   at 0 range SAI1RST  .R'First .. SAI1RST  .R'Last;
            SPI6RST   at 0 range SPI6RST  .R'First .. SPI6RST  .R'Last;
            SPI5RST   at 0 range SPI5RST  .R'First .. SPI5RST  .R'Last;
            ...
            SPI4RST   at 0 range SPI4RST  .R'First .. SPI4RST  .R'Last;
   ...
   function LTDCRST   is new APB2RSTR.FN.B (APB2RSTR.LTDCRST  );
   function SAI1RST   is new APB2RSTR.FN.B (APB2RSTR.SAI1RST  );
   function SPI6RST   is new APB2RSTR.FN.B (APB2RSTR.SPI6RST  );
   function SPI5RST   is new APB2RSTR.FN.B (APB2RSTR.SPI5RST  );
   ...
   function SPI4RST   is new APB2RSTR.FN.B (APB2RSTR.SPI4RST  );
   ...
   function Does_Not_Reset is new APB2RSTR.FN.C (APB2RSTR.LTDCRST, 2#0#);
   function Resets         is new APB2RSTR.FN.C (APB2RSTR.LTDCRST, 2#1#);

   function Does_Not_Reset is new APB2RSTR.FN.C (APB2RSTR.SAI1RST, 2#0#);
   function Resets         is new APB2RSTR.FN.C (APB2RSTR.SAI1RST, 2#1#);

   function Does_Not_Reset is new APB2RSTR.FN.C (APB2RSTR.SPI6RST, 2#0#);
   function Resets         is new APB2RSTR.FN.C (APB2RSTR.SPI6RST, 2#1#);

   function Does_Not_Reset is new APB2RSTR.FN.C (APB2RSTR.SPI5RST, 2#0#);
   function Resets         is new APB2RSTR.FN.C (APB2RSTR.SPI5RST, 2#1#);
   ...
   function Does_Not_Reset is new APB2RSTR.FN.C (APB2RSTR.SPI4RST, 2#0#);
   function Resets         is new APB2RSTR.FN.C (APB2RSTR.SPI4RST, 2#1#);
   ...
   package AHB1ENR is
      ...
      type T is
         record
            ...
            GPIOKEN      : AHB1ENR .GPIOKEN     . T;
            GPIOJEN      : AHB1ENR .GPIOJEN     . T;
      ...
      for T use
         record
            ...
            DMA2DEN      at 0 range DMA2DEN     .R'First .. DMA2DEN     .R'Last;
            ...
            GPIOKEN      at 0 range GPIOKEN     .R'First .. GPIOKEN     .R'Last;
            GPIOJEN      at 0 range GPIOJEN     .R'First .. GPIOJEN     .R'Last;
   ...
   function DMA2DEN      is new AHB1ENR.FN.B (AHB1ENR.DMA2DEN     );
   ...
   function GPIOKEN      is new AHB1ENR.FN.B (AHB1ENR.GPIOKEN      );
   function GPIOJEN      is new AHB1ENR.FN.B (AHB1ENR.GPIOJEN      );
   ...
   function Clock_Disabled is new AHB1ENR.FN.C (AHB1ENR.DMA2DEN, 2#0#);
   function Clock_Enabled  is new AHB1ENR.FN.C (AHB1ENR.DMA2DEN, 2#1#);
   ...
   function Clock_Disabled is new AHB1ENR.FN.C (AHB1ENR.GPIOKEN, 2#0#);
   function Clock_Enabled  is new AHB1ENR.FN.C (AHB1ENR.GPIOKEN, 2#1#);

   function Clock_Disabled is new AHB1ENR.FN.C (AHB1ENR.GPIOJEN, 2#0#);
   function Clock_Enabled  is new AHB1ENR.FN.C (AHB1ENR.GPIOJEN, 2#1#);
   ...
   package APB1ENR is
      ...
      type T is
         record
            UART8EN  : APB1ENR.UART8EN.T;
            UART7EN  : APB1ENR.UART7EN.T;
      ...
      for T use
         record
            UART8EN  at 0 range UART8EN.R'First .. UART8EN.R'Last;
            UART7EN  at 0 range UART7EN.R'First .. UART7EN.R'Last;
   ...
   function UART8EN  is new APB1ENR.FN.B (APB1ENR.UART8EN);
   function UART7EN  is new APB1ENR.FN.B (APB1ENR.UART7EN);
   ...
   function Clock_Disabled is new APB1ENR.FN.C (APB1ENR.UART8EN, 2#0#);
   function Clock_Enabled  is new APB1ENR.FN.C (APB1ENR.UART8EN, 2#1#);

   function Clock_Disabled is new APB1ENR.FN.C (APB1ENR.UART7EN, 2#0#);
   function Clock_Enabled  is new APB1ENR.FN.C (APB1ENR.UART7EN, 2#1#);
   ...
   package APB2ENR is
      ...
      type T is
         record
            LTDCEN   : APB2ENR.LTDCEN  .T;
            SAI1EN   : APB2ENR.SAI1EN  .T;
            SPI6EN   : APB2ENR.SPI6EN  .T;
            SPI5EN   : APB2ENR.SPI5EN  .T;
            TIM11EN  : APB2ENR.TIM11EN .T;
            TIM10EN  : APB2ENR.TIM10EN .T;
            TIM9EN   : APB2ENR.TIM9EN  .T;
            SYSCFGEN : APB2ENR.SYSCFGEN.T;
            SPI4EN   : APB2ENR.SPI4EN  .T;
      ...
      for T use
         record
            LTDCEN   at 0 range LTDCEN  .R'First .. LTDCEN  .R'Last;
            SAI1EN   at 0 range SAI1EN  .R'First .. SAI1EN  .R'Last;
            SPI6EN   at 0 range SPI6EN  .R'First .. SPI6EN  .R'Last;
            SPI5EN   at 0 range SPI5EN  .R'First .. SPI5EN  .R'Last;
            ...
            SPI4EN   at 0 range SPI4EN  .R'First .. SPI4EN  .R'Last;
   ...
   function LTDCEN   is new APB2ENR.FN.B (APB2ENR.LTDCEN  );
   function SAI1EN   is new APB2ENR.FN.B (APB2ENR.SAI1EN  );
   function SPI6EN   is new APB2ENR.FN.B (APB2ENR.SPI6EN  );
   function SPI5EN   is new APB2ENR.FN.B (APB2ENR.SPI5EN  );
   ...
   function SPI4EN   is new APB2ENR.FN.B (APB2ENR.SPI4EN  );
   ...
   function Clock_Disabled is new APB2ENR.FN.C (APB2ENR.LTDCEN, 2#0#);
   function Clock_Enabled  is new APB2ENR.FN.C (APB2ENR.LTDCEN, 2#1#);

   function Clock_Disabled is new APB2ENR.FN.C (APB2ENR.SAI1EN, 2#0#);
   function Clock_Enabled  is new APB2ENR.FN.C (APB2ENR.SAI1EN, 2#1#);

   function Clock_Disabled is new APB2ENR.FN.C (APB2ENR.SPI6EN, 2#0#);
   function Clock_Enabled  is new APB2ENR.FN.C (APB2ENR.SPI6EN, 2#1#);

   function Clock_Disabled is new APB2ENR.FN.C (APB2ENR.SPI5EN, 2#0#);
   function Clock_Enabled  is new APB2ENR.FN.C (APB2ENR.SPI5EN, 2#1#);
   ...
   function Clock_Disabled is new APB2ENR.FN.C (APB2ENR.SPI4EN, 2#0#);
   function Clock_Enabled  is new APB2ENR.FN.C (APB2ENR.SPI4EN, 2#1#);
   ...
   package AHB1LPENR is
      ...
      type T is
         record
            ...
            DMA2DLPEN     : AHB1LPENR .DMA2DLPEN     . T;
            DMA2LPEN      : AHB1LPENR .DMA2LPEN      . T;
            DMA1LPEN      : AHB1LPENR .DMA1LPEN      . T;
            SRAM3LPEN     : AHB1LPENR .SRAM3LPEN     . T;
            BKPSRAMLPEN   : AHB1LPENR .BKPSRAMLPEN   . T;
            SRAM2LPEN     : AHB1LPENR .SRAM2LPEN     . T;
            SRAM1LPEN     : AHB1LPENR .SRAM1LPEN     . T;
            FLITFLPEN     : AHB1LPENR .FLITFLPEN     . T;
            CRCLPEN       : AHB1LPENR .CRCLPEN       . T;
            GPIOKLPEN     : AHB1LPENR .GPIOKLPEN     . T;
            GPIOJLPEN     : AHB1LPENR .GPIOJLPEN     . T;
      ...
      for T use
         record
            ...
            DMA2DLPEN     at 0 range DMA2DLPEN     .R'First .. DMA2DLPEN     .R'Last;
            DMA2LPEN      at 0 range DMA2LPEN      .R'First .. DMA2LPEN      .R'Last;
            DMA1LPEN      at 0 range DMA1LPEN      .R'First .. DMA1LPEN      .R'Last;
            SRAM3LPEN     at 0 range SRAM3LPEN     .R'First .. SRAM3LPEN     .R'Last;
            BKPSRAMLPEN   at 0 range BKPSRAMLPEN   .R'First .. BKPSRAMLPEN   .R'Last;
            SRAM2LPEN     at 0 range SRAM2LPEN     .R'First .. SRAM2LPEN     .R'Last;
            SRAM1LPEN     at 0 range SRAM1LPEN     .R'First .. SRAM1LPEN     .R'Last;
            FLITFLPEN     at 0 range FLITFLPEN     .R'First .. FLITFLPEN     .R'Last;
            CRCLPEN       at 0 range CRCLPEN       .R'First .. CRCLPEN       .R'Last;
            GPIOKLPEN     at 0 range GPIOKLPEN     .R'First .. GPIOKLPEN     .R'Last;
            GPIOJLPEN     at 0 range GPIOJLPEN     .R'First .. GPIOJLPEN     .R'Last;
   ...
   function DMA2DLPEN     is new AHB1LPENR.FN.B (AHB1LPENR.DMA2DLPEN     );
   function DMA2LPEN      is new AHB1LPENR.FN.B (AHB1LPENR.DMA2LPEN      );
   function DMA1LPEN      is new AHB1LPENR.FN.B (AHB1LPENR.DMA1LPEN      );
   function SRAM3LPEN     is new AHB1LPENR.FN.B (AHB1LPENR.SRAM3LPEN     );
   function BKPSRAMLPEN   is new AHB1LPENR.FN.B (AHB1LPENR.BKPSRAMLPEN   );
   function SRAM2LPEN     is new AHB1LPENR.FN.B (AHB1LPENR.SRAM2LPEN     );
   function SRAM1LPEN     is new AHB1LPENR.FN.B (AHB1LPENR.SRAM1LPEN     );
   function FLITFLPEN     is new AHB1LPENR.FN.B (AHB1LPENR.FLITFLPEN     );
   function CRCLPEN       is new AHB1LPENR.FN.B (AHB1LPENR.CRCLPEN       );
   function GPIOKLPEN     is new AHB1LPENR.FN.B (AHB1LPENR.GPIOKLPEN      );
   function GPIOJLPEN     is new AHB1LPENR.FN.B (AHB1LPENR.GPIOJLPEN      );
   ...
   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.DMA2DLPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.DMA2DLPEN, 2#1#);
   ...
   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.SRAM3LPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.SRAM3LPEN, 2#1#);
   ...
   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.SRAM2LPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.SRAM2LPEN, 2#1#);

   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.SRAM1LPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.SRAM1LPEN, 2#1#);

   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.FLITFLPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.FLITFLPEN, 2#1#);
   ...
   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.GPIOKLPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.GPIOKLPEN, 2#1#);

   function Clock_Disabled is new AHB1LPENR.FN.C (AHB1LPENR.GPIOJLPEN, 2#0#);
   function Clock_Enabled  is new AHB1LPENR.FN.C (AHB1LPENR.GPIOJLPEN, 2#1#);
   ...
   package APB1LPENR is
      ...
      type T is
         record
            UART8LPEN : APB1LPENR.UART8LPEN.T;
            UART7LPEN : APB1LPENR.UART7LPEN.T;
            ...
            UART3LPEN : APB1LPENR.UART3LPEN.T;
            UART2LPEN : APB1LPENR.UART2LPEN.T;
      ...
      for T use
         record
            UART8LPEN at 0 range UART8LPEN.R'First .. UART8LPEN.R'Last;
            UART7LPEN at 0 range UART7LPEN.R'First .. UART7LPEN.R'Last;
            ...
            UART3LPEN at 0 range UART3LPEN.R'First .. UART3LPEN.R'Last;
            UART2LPEN at 0 range UART2LPEN.R'First .. UART2LPEN.R'Last;
   ...
   function UART8LPEN is new APB1LPENR.FN.B (APB1LPENR.UART8LPEN);
   function UART7LPEN is new APB1LPENR.FN.B (APB1LPENR.UART7LPEN);
   ...
   function UART3LPEN is new APB1LPENR.FN.B (APB1LPENR.UART3LPEN);
   function UART2LPEN is new APB1LPENR.FN.B (APB1LPENR.UART2LPEN);
   ...
   function Clock_Disabled is new APB1LPENR.FN.C (APB1LPENR.UART8LPEN, 2#0#);
   function Clock_Enabled  is new APB1LPENR.FN.C (APB1LPENR.UART8LPEN, 2#1#);

   function Clock_Disabled is new APB1LPENR.FN.C (APB1LPENR.UART7LPEN, 2#0#);
   function Clock_Enabled  is new APB1LPENR.FN.C (APB1LPENR.UART7LPEN, 2#1#);
   ...
   function Clock_Disabled is new APB1LPENR.FN.C (APB1LPENR.UART3LPEN, 2#0#);
   function Clock_Enabled  is new APB1LPENR.FN.C (APB1LPENR.UART3LPEN, 2#1#);

   function Clock_Disabled is new APB1LPENR.FN.C (APB1LPENR.UART2LPEN, 2#0#);
   function Clock_Enabled  is new APB1LPENR.FN.C (APB1LPENR.UART2LPEN, 2#1#);
   ...
   package APB2LPENR is
      ...
      type T is
         record
            LTDCLPEN   : APB2LPENR.LTDCLPEN  .T;
            SAI1LPEN   : APB2LPENR.SAI1LPEN  .T;
            SPI6LPEN   : APB2LPENR.SPI6LPEN  .T;
            SPI5LPEN   : APB2LPENR.SPI5LPEN  .T;
      ...
      for T use
         record
            LTDCLPEN   at 0 range LTDCLPEN  .R'First .. LTDCLPEN  .R'Last;
            SAI1LPEN   at 0 range SAI1LPEN  .R'First .. SAI1LPEN  .R'Last;
            SPI6LPEN   at 0 range SPI6LPEN  .R'First .. SPI6LPEN  .R'Last;
            SPI5LPEN   at 0 range SPI5LPEN  .R'First .. SPI5LPEN  .R'Last;
            ...
            SPI4LPEN   at 0 range SPI4LPEN  .R'First .. SPI4LPEN  .R'Last;
   ...
   function LTDCLPEN   is new APB2LPENR.FN.B (APB2LPENR.LTDCLPEN  );
   function SAI1LPEN   is new APB2LPENR.FN.B (APB2LPENR.SAI1LPEN  );
   function SPI6LPEN   is new APB2LPENR.FN.B (APB2LPENR.SPI6LPEN  );
   function SPI5LPEN   is new APB2LPENR.FN.B (APB2LPENR.SPI5LPEN  );
   ...
   function SPI4LPEN   is new APB2LPENR.FN.B (APB2LPENR.SPI4LPEN  );
   ...
   function Clock_Disabled is new APB2LPENR.FN.C (APB2LPENR.LTDCLPEN, 2#0#);
   function Clock_Enabled  is new APB2LPENR.FN.C (APB2LPENR.LTDCLPEN, 2#1#);

   function Clock_Disabled is new APB2LPENR.FN.C (APB2LPENR.SAI1LPEN, 2#0#);
   function Clock_Enabled  is new APB2LPENR.FN.C (APB2LPENR.SAI1LPEN, 2#1#);

   function Clock_Disabled is new APB2LPENR.FN.C (APB2LPENR.SPI6LPEN, 2#0#);
   function Clock_Enabled  is new APB2LPENR.FN.C (APB2LPENR.SPI6LPEN, 2#1#);

   function Clock_Disabled is new APB2LPENR.FN.C (APB2LPENR.SPI5LPEN, 2#0#);
   function Clock_Enabled  is new APB2LPENR.FN.C (APB2LPENR.SPI5LPEN, 2#1#);
   ...
   function Clock_Disabled is new APB2LPENR.FN.C (APB2LPENR.SPI4LPEN, 2#0#);
   function Clock_Enabled  is new APB2LPENR.FN.C (APB2LPENR.SPI4LPEN, 2#1#);
   ...
   package PLLI2SCFGR is
      ...
      for T use
         record
            ...
            PLLI2SQ at 0 range PLLI2SQ.R'First .. PLLI2SQ.R'Last;
   ...
   function PLLI2SQ is new PLLI2SCFGR.FN.B (PLLI2SCFGR.PLLI2SQ);
   ...
   package PLLSAICFGR is
      ...
      type T is
         record
            PLLSAIR : PLLSAICFGR.PLLSAIR.T;
            PLLSAIQ : PLLSAICFGR.PLLSAIQ.T;
            PLLSAIN : PLLSAICFGR.PLLSAIN.T;
         end record;

      for T use
         record
            PLLSAIR at 0 range PLLSAIR.R'First .. PLLSAIR.R'Last;
            PLLSAIQ at 0 range PLLSAIQ.R'First .. PLLSAIQ.R'Last;
            PLLSAIN at 0 range PLLSAIN.R'First .. PLLSAIN.R'Last;
         end record;
   ...
   function PLLSAIR is new PLLSAICFGR.FN.B (PLLSAICFGR.PLLSAIR);
   function PLLSAIQ is new PLLSAICFGR.FN.B (PLLSAICFGR.PLLSAIQ);
   function PLLSAIN is new PLLSAICFGR.FN.B (PLLSAICFGR.PLLSAIN);

   --  Functions

   function  "+"   is new PLLSAICFGR.FN.Add;
   function  "+"   is new PLLSAICFGR.FN.Add_RM;
   function  "-"   is new PLLSAICFGR.FN.Clear;
   function  Init  is new PLLSAICFGR.FN.Init;
   ...
   package DCKCFGR is
      ...
      type T is
         record
            TIMPRE     : DCKCFGR.TIMPRE    .T;
            SAI1BSRC   : DCKCFGR.SAI1BSRC  .T;
            SAI1ASRC   : DCKCFGR.SAI1ASRC  .T;
            PLLSAIDIVR : DCKCFGR.PLLSAIDIVR.T;
            PLLSAIDIVQ : DCKCFGR.PLLSAIDIVQ.T;
            PLLI2SDIVQ : DCKCFGR.PLLI2SDIVQ.T;
         end record;

      for T use
         record
            TIMPRE     at 0 range TIMPRE    .R'First .. TIMPRE    .R'Last;
            SAI1BSRC   at 0 range SAI1BSRC  .R'First .. SAI1BSRC  .R'Last;
            SAI1ASRC   at 0 range SAI1ASRC  .R'First .. SAI1ASRC  .R'Last;
            PLLSAIDIVR at 0 range PLLSAIDIVR.R'First .. PLLSAIDIVR.R'Last;
            PLLSAIDIVQ at 0 range PLLSAIDIVQ.R'First .. PLLSAIDIVQ.R'Last;
            PLLI2SDIVQ at 0 range PLLI2SDIVQ.R'First .. PLLI2SDIVQ.R'Last;
         end record;
   ...
   function TIMPRE     is new DCKCFGR.FN.B (DCKCFGR.TIMPRE    );
   function SAI1BSRC   is new DCKCFGR.FN.B (DCKCFGR.SAI1BSRC  );
   function SAI1ASRC   is new DCKCFGR.FN.B (DCKCFGR.SAI1ASRC  );
   function PLLSAIDIVR is new DCKCFGR.FN.B (DCKCFGR.PLLSAIDIVR);
   function PLLSAIDIVQ is new DCKCFGR.FN.B (DCKCFGR.PLLSAIDIVQ);
   function PLLI2SDIVQ is new DCKCFGR.FN.B (DCKCFGR.PLLI2SDIVQ);

   --  Functions

   function  "+"   is new DCKCFGR.FN.Add;
   function  "+"   is new DCKCFGR.FN.Add_RM;
   function  "-"   is new DCKCFGR.FN.Clear;
   function  Init  is new DCKCFGR.FN.Init;
   ...
   type RCC_T is
      record
         ...
         pragma Volatile (PLLSAICFGR);
         pragma Volatile (DCKCFGR);
      end record;
