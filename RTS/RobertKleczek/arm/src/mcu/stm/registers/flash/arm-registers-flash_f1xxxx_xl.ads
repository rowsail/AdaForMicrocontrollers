...
--                                                                            --
--          A R M . R e g i s t e r s . F L A S H _ F 1 X X X X _ X L         --
--                                   S p e c                                  --
--                                                                            --
...
--------------------------------------------------------------------------------
--                           ARM.Registers.FLASH_F1XXXX_XL                    --
--------------------------------------------------------------------------------

package ARM.Registers.FLASH_F1XXXX_XL is
   ...
   function Half_Cycle_Is_Disabled is new ACR.FN.C (ACR.HLFCYA, 2#0#);
   function Half_Cycle_Is_Enabled  is new ACR.FN.C (ACR.HLFCYA, 2#1#);
   ...
   function Set is new CR.FN.C (CR.OPTWRE, 2#1#);

   function Locked is new CR.FN.C (CR.LOCK, 2#1#);
   ...
   package OBR is
      ...
      for T use
         record
            ...
            RDPRT      at 0 range RDPRT.R'First .. RDPRT.R'Last;
   ...
   function BFB2       is new OBR.FN.B (OBR.BFB2);
   ...
   function RDPRT      is new OBR.FN.B (OBR.RDPRT);
   ...
   subtype KEYR2_T is R32;
   pragma Suppress_Initialization (KEYR2_T);
   ...
   function EOP      is new SR2.FN.B (SR2.EOP);
   function WRPRTERR is new SR2.FN.B (SR2.WRPRTERR);
   function PGERR    is new SR2.FN.B (SR2.PGERR);
   function BSY      is new SR2.FN.B (SR2.BSY);

   --  Functions

   function  "+"   is new SR2.FN.Add;
   function  "+"   is new SR2.FN.Add_RM;
   function  "-"   is new SR2.FN.Clear;
   function  Init  is new SR2.FN.Init;

   --  Constant definitions

   function Reset is new SR2.FN.C (SR2.EOP, 2#1#);

   function Reset is new SR2.FN.C (SR2.WRPRTERR, 2#1#);

   function Reset is new SR2.FN.C (SR2.PGERR, 2#1#);

   function Busy  is new SR2.FN.C (SR2.BSY, 2#1#);
   ...
   function EOPIE      is new CR2.FN.B (CR2.EOPIE);
   function ERRIE      is new CR2.FN.B (CR2.ERRIE);
   function LOCK       is new CR2.FN.B (CR2.LOCK);
   function STRT       is new CR2.FN.B (CR2.STRT);
   function MER        is new CR2.FN.B (CR2.MER);
   function PER        is new CR2.FN.B (CR2.PER);
   function PG         is new CR2.FN.B (CR2.PG);

   --  Functions

   function  "+"   is new CR2.FN.Add;
   function  "+"   is new CR2.FN.Add_RM;
   function  "-"   is new CR2.FN.Clear;
   function  Init  is new CR2.FN.Init;

   --  Constant definitions

   function Interrupt_Generation_Disabled is new CR2.FN.C (CR2.EOPIE, 2#0#);
   function Interrupt_Generation_Enabled  is new CR2.FN.C (CR2.EOPIE, 2#1#);

   function Interrupt_Generation_Disabled is new CR2.FN.C (CR2.ERRIE, 2#0#);
   function Interrupt_Generation_Enabled  is new CR2.FN.C (CR2.ERRIE, 2#1#);

   function Locked is new CR2.FN.C (CR2.LOCK, 2#1#);

   function Start is new CR2.FN.C (CR2.STRT, 2#1#);

   --------------------------
   --  Address Register 2  --
   --------------------------

   subtype AR2_T is R32;
   pragma Suppress_Initialization (AR2_T);
   ...
   for FLASH_T use
      record
         ...
         KEYR2     at 16#44# range 0 .. 31;
         SR2       at 16#4C# range 0 .. 31;
         CR2       at 16#50# range 0 .. 31;
         AR2       at 16#54# range 0 .. 31;
      end record;
...
end ARM.Registers.FLASH_F1XXXX_XL;
