...
--                                                                            --
--             A R M . R e g i s t e r s . F L A S H _ F 4 0 X X X            --
--                                   S p e c                                  --
--                                                                            --
...
--  Package defines STM32 F40XXX family flash related registers
...
--------------------------------------------------------------------------------
--                           ARM.Registers.FLASH_F40XXX                       --
--------------------------------------------------------------------------------

package ARM.Registers.FLASH_F40XXX is
   ...
   function Latency_3WS is new ACR.FN.C (ACR.LATENCY, 2#011#);
   function Latency_4WS is new ACR.FN.C (ACR.LATENCY, 2#100#);
   function Latency_5WS is new ACR.FN.C (ACR.LATENCY, 2#101#);
   function Latency_6WS is new ACR.FN.C (ACR.LATENCY, 2#110#);
   function Latency_7WS is new ACR.FN.C (ACR.LATENCY, 2#111#);
...
end ARM.Registers.FLASH_F40XXX;
