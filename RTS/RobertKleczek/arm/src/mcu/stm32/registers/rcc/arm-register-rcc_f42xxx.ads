...
--                                                                            --
--                 A R M . R e g i s t e r . R C C _ F 4 2 X X X              --
--                                   S p e c                                  --
--                                                                            --
...
--  Package defines STM32 F42XXX family reset & clock related registers
...
--------------------------------------------------------------------------------
--                            ARM.Register.RCC_F42XXX                         --
--------------------------------------------------------------------------------

package ARM.Register.RCC_F42XXX is
   ...
   package RCC_CR is
      ...
      package PLLSAIRDY is new Bitfield (Tp, 29);
      package PLLSAION  is new Bitfield (Tp, 28);
      ...
      type T is
         record
            PLLSAIRDY : RCC_CR.PLLSAIRDY.T;
            PLLSAION  : RCC_CR.PLLSAION .T;
      ...
      for T use
         record
            PLLSAIRDY at 0 range PLLSAIRDY.F .. PLLSAIRDY.L;
            PLLSAION  at 0 range PLLSAION .F .. PLLSAION .L;
   ...
   package CR    is new Register (RCC_CR.T, RCC_CR.Tp, 16#4002_3800#);
   ...
   function PLLSAIRDY is new CR.B (RCC_CR.PLLSAIRDY) with Inline_Always;
   function PLLSAION  is new CR.B (RCC_CR.PLLSAION ) with Inline_Always;
   ...
   function PLLSAI_Unlocked is new CR.C (RCC_CR.PLLSAIRDY, 2#0#) with Inline_Always;
   function PLLSAI_Locked   is new CR.C (RCC_CR.PLLSAIRDY, 2#1#) with Inline_Always;

   function PLLSAI_Off is new CR.C (RCC_CR.PLLSAION, 2#0#) with Inline_Always;
   function PLLSAI_On  is new CR.C (RCC_CR.PLLSAION, 2#1#) with Inline_Always;
   ...
   package PLLCFGR    is new Register (RCC_PLLCFGR.T, RCC_PLLCFGR.Tp, 16#4002_3804#);
   ...
   function HSI_Clock_Selected             is new PLLCFGR.C (RCC_PLLCFGR.PLLSRC, 2#0#) with Inline_Always;
   function HSE_Osclillator_Clock_Selected is new PLLCFGR.C (RCC_PLLCFGR.PLLSRC, 2#1#) with Inline_Always;
   ...
   package RCC_CIR is
      ...
      package PLLSAIRDYC  is new Bitfield (Tp, 22);
      ...
      package PLLSAIRDYIE is new Bitfield (Tp, 14);
      ...
      package PLLSAIRDYF  is new Bitfield (Tp, 6);
      ...
      type T is
         record
            CSSC        : RCC_CIR.CSSC       .T;
            PLLSAIRDYC  : RCC_CIR.PLLSAIRDYC .T;
            ...
            PLLSAIRDYIE : RCC_CIR.PLLSAIRDYIE.T;
            ...
            CSSF        : RCC_CIR.CSSF       .T;
            PLLSAIRDYF  : RCC_CIR.PLLSAIRDYF .T;
      ...
      for T use
         record
            ...
            PLLSAIRDYC  at 0 range PLLSAIRDYC .F .. PLLSAIRDYC .L;
            ...
            PLLSAIRDYIE at 0 range PLLSAIRDYIE.F .. PLLSAIRDYIE.L;
            ...
            PLLSAIRDYF  at 0 range PLLSAIRDYF .F .. PLLSAIRDYF .L;
   ...
   function PLLSAIRDYC  is new CIR.B (RCC_CIR.PLLSAIRDYC ) with Inline_Always;
   ...
   function PLLSAIRDYIE is new CIR.B (RCC_CIR.PLLSAIRDYIE) with Inline_Always;
   ...
   function PLLSAIRDYF  is new CIR.B (RCC_CIR.PLLSAIRDYF ) with Inline_Always;
   ...
   function Clear_Flag is new CIR.C (RCC_CIR.PLLSAIRDYC, 2#1#) with Inline_Always;
   ...
   function Lock_Interrupt_Disabled is new CIR.C (RCC_CIR.PLLSAIRDYIE, 2#0#) with Inline_Always;
   function Lock_Interrupt_Enabled  is new CIR.C (RCC_CIR.PLLSAIRDYIE, 2#1#) with Inline_Always;
   ...
   function No_Clock_Security is new CIR.C (RCC_CIR.PLLSAIRDYF, 2#0#) with Inline_Always;
   function Clock_Security    is new CIR.C (RCC_CIR.PLLSAIRDYF, 2#1#) with Inline_Always;
   ...
   package RCC_AHB1RSTR is
      ...
      package DMA2DRST  is new Bitfield (Tp, 23);
      package DMA2RST   is new Bitfield (Tp, 22);
      package DMA1RST   is new Bitfield (Tp, 21);
      package CRCRST    is new Bitfield (Tp, 12);
      package GPIOKRST  is new Bitfield (Tp, 10);
      package GPIOJRST  is new Bitfield (Tp, 9);
      ...
      type T is
         record
            ...
            DMA2DRST  : RCC_AHB1RSTR.DMA2DRST .T;
            DMA2RST   : RCC_AHB1RSTR.DMA2RST  .T;
            DMA1RST   : RCC_AHB1RSTR.DMA1RST  .T;
            CRCRST    : RCC_AHB1RSTR.CRCRST   .T;
            GPIOKRST  : RCC_AHB1RSTR.GPIOKRST .T;
            GPIOJRST  : RCC_AHB1RSTR.GPIOJRST .T;
      ...
      for T use
         record
            ...
            DMA2DRST  at 0 range DMA2DRST .F .. DMA2DRST .L;
            DMA2RST   at 0 range DMA2RST  .F .. DMA2RST  .L;
            DMA1RST   at 0 range DMA1RST  .F .. DMA1RST  .L;
            CRCRST    at 0 range CRCRST   .F .. CRCRST   .L;
            GPIOKRST  at 0 range GPIOKRST .F .. GPIOKRST .L;
            GPIOJRST  at 0 range GPIOJRST .F .. GPIOJRST .L;
   ...
   function DMA2dRST  is new AHB1RSTR.B (RCC_AHB1RSTR.DMA2dRST ) with Inline_Always;
   ...
   function GPIOKRST  is new AHB1RSTR.B (RCC_AHB1RSTR.GPIOKRST ) with Inline_Always;
   function GPIOJRST  is new AHB1RSTR.B (RCC_AHB1RSTR.GPIOJRST ) with Inline_Always;
   ...
   function Does_Not_Reset is new AHB1RSTR.C (RCC_AHB1RSTR.DMA2DRST, 2#0#) with Inline_Always;
   function Resets         is new AHB1RSTR.C (RCC_AHB1RSTR.DMA2DRST, 2#1#) with Inline_Always;
   ...
   function Does_Not_Reset is new AHB1RSTR.C (RCC_AHB1RSTR.GPIOKRST, 2#0#) with Inline_Always;
   function Resets         is new AHB1RSTR.C (RCC_AHB1RSTR.GPIOKRST, 2#1#) with Inline_Always;

   function Does_Not_Reset is new AHB1RSTR.C (RCC_AHB1RSTR.GPIOJRST, 2#0#) with Inline_Always;
   function Resets         is new AHB1RSTR.C (RCC_AHB1RSTR.GPIOJRST, 2#1#) with Inline_Always;
   ...
   package RCC_APB1RSTR is
      ...
      package UART8RST is new Bitfield (Tp, 31);
      package UART7RST is new Bitfield (Tp, 30);
      ...
      type T is
         record
            UART8RST : RCC_APB1RSTR.UART8RST.T;
            UART7RST : RCC_APB1RSTR.UART7RST.T;
      ...
      for T use
         record
            UART8RST at 0 range UART8RST.F .. UART8RST.L;
            UART7RST at 0 range UART7RST.F .. UART7RST.L;
   ...
   function UART8RST is new APB1RSTR.B (RCC_APB1RSTR.UART8RST) with Inline_Always;
   function UART7RST is new APB1RSTR.B (RCC_APB1RSTR.UART7RST) with Inline_Always;
   ...
   function Does_Not_Reset is new APB1RSTR.C (RCC_APB1RSTR.UART8RST, 2#0#) with Inline_Always;
   function Resets         is new APB1RSTR.C (RCC_APB1RSTR.UART8RST, 2#1#) with Inline_Always;

   function Does_Not_Reset is new APB1RSTR.C (RCC_APB1RSTR.UART7RST, 2#0#) with Inline_Always;
   function Resets         is new APB1RSTR.C (RCC_APB1RSTR.UART7RST, 2#1#) with Inline_Always;
   ...
   package RCC_APB2RSTR is
      ...
      package LTDCRST   is new Bitfield (Tp, 26);
      package SAI1RST   is new Bitfield (Tp, 22);
      package SPI6RST   is new Bitfield (Tp, 21);
      package SPI5RST   is new Bitfield (Tp, 20);
      ...
      package SPI4RST   is new Bitfield (Tp, 13);
      ...
      type T is
         record
            LTDCRST   : RCC_APB2RSTR.LTDCRST  .T;
            SAI1RST   : RCC_APB2RSTR.SAI1RST  .T;
            SPI6RST   : RCC_APB2RSTR.SPI6RST  .T;
            SPI5RST   : RCC_APB2RSTR.SPI5RST  .T;
            ...
            SPI4RST   : RCC_APB2RSTR.SPI4RST  .T;
      ...
      for T use
         record
            LTDCRST   at 0 range LTDCRST  .F .. LTDCRST  .L;
            SAI1RST   at 0 range SAI1RST  .F .. SAI1RST  .L;
            SPI6RST   at 0 range SPI6RST  .F .. SPI6RST  .L;
            SPI5RST   at 0 range SPI5RST  .F .. SPI5RST  .L;
            ...
            SPI4RST   at 0 range SPI4RST  .F .. SPI4RST  .L;
   ...
   function LTDCRST   is new APB2RSTR.B (RCC_APB2RSTR.LTDCRST  ) with Inline_Always;
   function SAI1RST   is new APB2RSTR.B (RCC_APB2RSTR.SAI1RST  ) with Inline_Always;
   function SPI6RST   is new APB2RSTR.B (RCC_APB2RSTR.SPI6RST  ) with Inline_Always;
   function SPI5RST   is new APB2RSTR.B (RCC_APB2RSTR.SPI5RST  ) with Inline_Always;
   ...
   function SPI4RST   is new APB2RSTR.B (RCC_APB2RSTR.SPI4RST  ) with Inline_Always;
   ...
   function Does_Not_Reset is new APB2RSTR.C (RCC_APB2RSTR.LTDCRST, 2#0#) with Inline_Always;
   function Resets         is new APB2RSTR.C (RCC_APB2RSTR.LTDCRST, 2#1#) with Inline_Always;

   function Does_Not_Reset is new APB2RSTR.C (RCC_APB2RSTR.SAI1RST, 2#0#) with Inline_Always;
   function Resets         is new APB2RSTR.C (RCC_APB2RSTR.SAI1RST, 2#1#) with Inline_Always;

   function Does_Not_Reset is new APB2RSTR.C (RCC_APB2RSTR.SPI6RST, 2#0#) with Inline_Always;
   function Resets         is new APB2RSTR.C (RCC_APB2RSTR.SPI6RST, 2#1#) with Inline_Always;

   function Does_Not_Reset is new APB2RSTR.C (RCC_APB2RSTR.SPI5RST, 2#0#) with Inline_Always;
   function Resets         is new APB2RSTR.C (RCC_APB2RSTR.SPI5RST, 2#1#) with Inline_Always;
   ...
   function Does_Not_Reset is new APB2RSTR.C (RCC_APB2RSTR.SPI4RST, 2#0#) with Inline_Always;
   function Resets         is new APB2RSTR.C (RCC_APB2RSTR.SPI4RST, 2#1#) with Inline_Always;
   ...
   package RCC_AHB1ENR is
      ...
      package DMA2DEN      is new Bitfield (Tp, 23);
      ...
      package GPIOKEN      is new Bitfield (Tp, 10);
      package GPIOJEN      is new Bitfield (Tp, 9);
      ...
      type T is
         record
            ...
            GPIOKEN      : RCC_AHB1ENR.GPIOKEN     .T;
            GPIOJEN      : RCC_AHB1ENR.GPIOJEN     .T;
      ...
      for T use
         record
            ...
            DMA2DEN      at 0 range DMA2DEN     .F .. DMA2DEN     .L;
            ...
            GPIOKEN      at 0 range GPIOKEN     .F .. GPIOKEN     .L;
            GPIOJEN      at 0 range GPIOJEN     .F .. GPIOJEN     .L;
   ...
   function DMA2DEN      is new AHB1ENR.B (RCC_AHB1ENR.DMA2DEN      ) with Inline_Always;
   ...
   function GPIOKEN      is new AHB1ENR.B (RCC_AHB1ENR.GPIOKEN      ) with Inline_Always;
   function GPIOJEN      is new AHB1ENR.B (RCC_AHB1ENR.GPIOJEN      ) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1ENR.C (RCC_AHB1ENR.DMA2DEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1ENR.C (RCC_AHB1ENR.DMA2DEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1ENR.C (RCC_AHB1ENR.GPIOKEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1ENR.C (RCC_AHB1ENR.GPIOKEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new AHB1ENR.C (RCC_AHB1ENR.GPIOJEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1ENR.C (RCC_AHB1ENR.GPIOJEN, 2#1#) with Inline_Always;
   ...
   package RCC_APB1ENR is
      ...
      package UART8EN  is new Bitfield (Tp, 31);
      package UART7EN  is new Bitfield (Tp, 30);
      ...
      type T is
         record
            UART8EN  : RCC_APB1ENR.UART8EN.T;
            UART7EN  : RCC_APB1ENR.UART7EN.T;
      ...
      for T use
         record
            UART8EN  at 0 range UART8EN .F .. UART8EN .L;
            UART7EN  at 0 range UART7EN .F .. UART7EN .L;
   ...
   function UART8EN  is new APB1ENR.B (RCC_APB1ENR.UART8EN ) with Inline_Always;
   function UART7EN  is new APB1ENR.B (RCC_APB1ENR.UART7EN ) with Inline_Always;
   ...
   function Clock_Disabled is new APB1ENR.C (RCC_APB1ENR.UART8EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1ENR.C (RCC_APB1ENR.UART8EN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB1ENR.C (RCC_APB1ENR.UART7EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1ENR.C (RCC_APB1ENR.UART7EN, 2#1#) with Inline_Always;
   ...
   package RCC_APB2ENR is
      ...
      package LTDCEN   is new Bitfield (Tp, 26);
      package SAI1EN   is new Bitfield (Tp, 22);
      package SPI6EN   is new Bitfield (Tp, 21);
      package SPI5EN   is new Bitfield (Tp, 20);
      ...
      package SPI4EN   is new Bitfield (Tp, 13);
      ...
      type T is
         record
            LTDCEN   : RCC_APB2ENR.LTDCEN  .T;
            SAI1EN   : RCC_APB2ENR.SAI1EN  .T;
            SPI6EN   : RCC_APB2ENR.SPI6EN  .T;
            SPI5EN   : RCC_APB2ENR.SPI5EN  .T;
            TIM11EN  : RCC_APB2ENR.TIM11EN .T;
            TIM10EN  : RCC_APB2ENR.TIM10EN .T;
            TIM9EN   : RCC_APB2ENR.TIM9EN  .T;
            SYSCFGEN : RCC_APB2ENR.SYSCFGEN.T;
            SPI4EN   : RCC_APB2ENR.SPI4EN  .T;
      ...
      for T use
         record
            LTDCEN   at 0 range LTDCEN  .F .. LTDCEN  .L;
            SAI1EN   at 0 range SAI1EN  .F .. SAI1EN  .L;
            SPI6EN   at 0 range SPI6EN  .F .. SPI6EN  .L;
            SPI5EN   at 0 range SPI5EN  .F .. SPI5EN  .L;
            ...
            SPI4EN   at 0 range SPI4EN  .F .. SPI4EN  .L;
   ...
   function LTDCEN   is new APB2ENR.B (RCC_APB2ENR.LTDCEN  ) with Inline_Always;
   function SAI1EN   is new APB2ENR.B (RCC_APB2ENR.SAI1EN  ) with Inline_Always;
   function SPI6EN   is new APB2ENR.B (RCC_APB2ENR.SPI6EN  ) with Inline_Always;
   function SPI5EN   is new APB2ENR.B (RCC_APB2ENR.SPI5EN  ) with Inline_Always;
   ...
   function SPI4EN   is new APB2ENR.B (RCC_APB2ENR.SPI4EN  ) with Inline_Always;
   ...
   function Clock_Disabled is new APB2ENR.C (RCC_APB2ENR.LTDCEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2ENR.C (RCC_APB2ENR.LTDCEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2ENR.C (RCC_APB2ENR.SAI1EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2ENR.C (RCC_APB2ENR.SAI1EN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2ENR.C (RCC_APB2ENR.SPI6EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2ENR.C (RCC_APB2ENR.SPI6EN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2ENR.C (RCC_APB2ENR.SPI5EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2ENR.C (RCC_APB2ENR.SPI5EN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new APB2ENR.C (RCC_APB2ENR.SPI4EN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2ENR.C (RCC_APB2ENR.SPI4EN, 2#1#) with Inline_Always;
   ...
   package RCC_AHB1LPENR is
      ...
      package DMA2DLPEN     is new Bitfield (Tp, 23);
      package DMA2LPEN      is new Bitfield (Tp, 22);
      package DMA1LPEN      is new Bitfield (Tp, 21);
      package SRAM3LPEN     is new Bitfield (Tp, 19);
      package BKPSRAMLPEN   is new Bitfield (Tp, 18);
      package SRAM2LPEN     is new Bitfield (Tp, 17);
      package SRAM1LPEN     is new Bitfield (Tp, 16);
      package FLITFLPEN     is new Bitfield (Tp, 15);
      package CRCLPEN       is new Bitfield (Tp, 12);
      package GPIOKLPEN     is new Bitfield (Tp, 10);
      package GPIOJLPEN     is new Bitfield (Tp, 9);
      ...
      type T is
         record
            ...
            DMA2DLPEN     : RCC_AHB1LPENR.DMA2DLPEN     .T;
            DMA2LPEN      : RCC_AHB1LPENR.DMA2LPEN      .T;
            DMA1LPEN      : RCC_AHB1LPENR.DMA1LPEN      .T;
            SRAM3LPEN     : RCC_AHB1LPENR.SRAM3LPEN     .T;
            BKPSRAMLPEN   : RCC_AHB1LPENR.BKPSRAMLPEN   .T;
            SRAM2LPEN     : RCC_AHB1LPENR.SRAM2LPEN     .T;
            SRAM1LPEN     : RCC_AHB1LPENR.SRAM1LPEN     .T;
            FLITFLPEN     : RCC_AHB1LPENR.FLITFLPEN     .T;
            CRCLPEN       : RCC_AHB1LPENR.CRCLPEN       .T;
            GPIOKLPEN     : RCC_AHB1LPENR.GPIOKLPEN     .T;
            GPIOJLPEN     : RCC_AHB1LPENR.GPIOJLPEN     .T;
      ...
      for T use
         record
            ...
            DMA2DLPEN     at 0 range DMA2DLPEN     .F .. DMA2DLPEN     .L;
            DMA2LPEN      at 0 range DMA2LPEN      .F .. DMA2LPEN      .L;
            DMA1LPEN      at 0 range DMA1LPEN      .F .. DMA1LPEN      .L;
            SRAM3LPEN     at 0 range SRAM3LPEN     .F .. SRAM3LPEN     .L;
            BKPSRAMLPEN   at 0 range BKPSRAMLPEN   .F .. BKPSRAMLPEN   .L;
            SRAM2LPEN     at 0 range SRAM2LPEN     .F .. SRAM2LPEN     .L;
            SRAM1LPEN     at 0 range SRAM1LPEN     .F .. SRAM1LPEN     .L;
            FLITFLPEN     at 0 range FLITFLPEN     .F .. FLITFLPEN     .L;
            CRCLPEN       at 0 range CRCLPEN       .F .. CRCLPEN       .L;
            GPIOKLPEN     at 0 range GPIOKLPEN     .F .. GPIOKLPEN     .L;
            GPIOJLPEN     at 0 range GPIOJLPEN     .F .. GPIOJLPEN     .L;
   ...
   function DMA2DLPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.DMA2DLPEN      ) with Inline_Always;
   ...
   function SRAM3LPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.SRAM3LPEN      ) with Inline_Always;
   function BKPSRAMLPEN   is new AHB1LPENR.B (RCC_AHB1LPENR.BKPSRAMLPEN    ) with Inline_Always;
   function SRAM2LPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.SRAM2LPEN      ) with Inline_Always;
   function SRAM1LPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.SRAM1LPEN      ) with Inline_Always;
   function FLITFLPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.FLITFLPEN      ) with Inline_Always;
   function CRCLPEN       is new AHB1LPENR.B (RCC_AHB1LPENR.CRCLPEN        ) with Inline_Always;
   function GPIOKLPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.GPIOKLPEN      ) with Inline_Always;
   function GPIOJLPEN     is new AHB1LPENR.B (RCC_AHB1LPENR.GPIOJLPEN      ) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.DMA2DLPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.DMA2DLPEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM3LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM3LPEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM2LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM2LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM1LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.SRAM1LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.FLITFLPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.FLITFLPEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.GPIOKLPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.GPIOKLPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new AHB1LPENR.C (RCC_AHB1LPENR.GPIOJLPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new AHB1LPENR.C (RCC_AHB1LPENR.GPIOJLPEN, 2#1#) with Inline_Always;
   ...
   function "="  is new AHB3LPENR.Equal    with Inline_Always;
   ...
   package RCC_APB1LPENR is
      ...
      package UART8LPEN is new Bitfield (Tp, 31);
      package UART7LPEN is new Bitfield (Tp, 30);
      ...
      package UART3LPEN is new Bitfield (Tp, 18);
      package UART2LPEN is new Bitfield (Tp, 17);
      ...
      type T is
         record
            UART8LPEN : RCC_APB1LPENR.UART8LPEN.T;
            UART7LPEN : RCC_APB1LPENR.UART7LPEN.T;
            ...
            UART3LPEN : RCC_APB1LPENR.UART3LPEN.T;
            UART2LPEN : RCC_APB1LPENR.UART2LPEN.T;
      ...
      for T use
         record
            UART8LPEN at 0 range UART8LPEN.F .. UART8LPEN.L;
            UART7LPEN at 0 range UART7LPEN.F .. UART7LPEN.L;
            ...
            UART3LPEN at 0 range UART3LPEN.F .. UART3LPEN.L;
            UART2LPEN at 0 range UART2LPEN.F .. UART2LPEN.L;
   ...
   function UART8LPEN is new APB1LPENR.B (RCC_APB1LPENR.UART8LPEN) with Inline_Always;
   function UART7LPEN is new APB1LPENR.B (RCC_APB1LPENR.UART7LPEN) with Inline_Always;
   ...
   function UART3LPEN is new APB1LPENR.B (RCC_APB1LPENR.UART3LPEN) with Inline_Always;
   function UART2LPEN is new APB1LPENR.B (RCC_APB1LPENR.UART2LPEN) with Inline_Always;
   ...
   function Clock_Disabled is new APB1LPENR.C (RCC_APB1LPENR.UART8LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1LPENR.C (RCC_APB1LPENR.UART8LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB1LPENR.C (RCC_APB1LPENR.UART7LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1LPENR.C (RCC_APB1LPENR.UART7LPEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new APB1LPENR.C (RCC_APB1LPENR.UART3LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1LPENR.C (RCC_APB1LPENR.UART3LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB1LPENR.C (RCC_APB1LPENR.UART2LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB1LPENR.C (RCC_APB1LPENR.UART2LPEN, 2#1#) with Inline_Always;
   ...
   package RCC_APB2LPENR is
      ...
      package LTDCLPEN   is new Bitfield (Tp, 26);
      package SAI1LPEN   is new Bitfield (Tp, 22);
      package SPI6LPEN   is new Bitfield (Tp, 21);
      package SPI5LPEN   is new Bitfield (Tp, 20);
      ...
      package SPI4LPEN   is new Bitfield (Tp, 13);
      ...
      type T is
         record
            LTDCLPEN   : RCC_APB2LPENR.LTDCLPEN  .T;
            SAI1LPEN   : RCC_APB2LPENR.SAI1LPEN  .T;
            SPI6LPEN   : RCC_APB2LPENR.SPI6LPEN  .T;
            SPI5LPEN   : RCC_APB2LPENR.SPI5LPEN  .T;
            ...
            SPI4LPEN   : RCC_APB2LPENR.SPI4LPEN  .T;
      ...
      for T use
         record
            LTDCLPEN   at 0 range LTDCLPEN  .F .. LTDCLPEN  .L;
            SAI1LPEN   at 0 range SAI1LPEN  .F .. SAI1LPEN  .L;
            SPI6LPEN   at 0 range SPI6LPEN  .F .. SPI6LPEN  .L;
            SPI5LPEN   at 0 range SPI5LPEN  .F .. SPI5LPEN  .L;
            ...
            SPI4LPEN   at 0 range SPI4LPEN  .F .. SPI4LPEN  .L;
   ...
   function LTDCLPEN   is new APB2LPENR.B (RCC_APB2LPENR.LTDCLPEN  ) with Inline_Always;
   function SAI1LPEN   is new APB2LPENR.B (RCC_APB2LPENR.SAI1LPEN  ) with Inline_Always;
   function SPI6LPEN   is new APB2LPENR.B (RCC_APB2LPENR.SPI6LPEN  ) with Inline_Always;
   function SPI5LPEN   is new APB2LPENR.B (RCC_APB2LPENR.SPI5LPEN  ) with Inline_Always;
   ...
   function SPI4LPEN   is new APB2LPENR.B (RCC_APB2LPENR.SPI4LPEN  ) with Inline_Always;
   ...
   function Clock_Disabled is new APB2LPENR.C (RCC_APB2LPENR.LTDCLPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2LPENR.C (RCC_APB2LPENR.LTDCLPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2LPENR.C (RCC_APB2LPENR.SAI1LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2LPENR.C (RCC_APB2LPENR.SAI1LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2LPENR.C (RCC_APB2LPENR.SPI6LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2LPENR.C (RCC_APB2LPENR.SPI6LPEN, 2#1#) with Inline_Always;

   function Clock_Disabled is new APB2LPENR.C (RCC_APB2LPENR.SPI5LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2LPENR.C (RCC_APB2LPENR.SPI5LPEN, 2#1#) with Inline_Always;
   ...
   function Clock_Disabled is new APB2LPENR.C (RCC_APB2LPENR.SPI4LPEN, 2#0#) with Inline_Always;
   function Clock_Enabled  is new APB2LPENR.C (RCC_APB2LPENR.SPI4LPEN, 2#1#) with Inline_Always;
   ...
   package BDCR    is new Register (RCC_BDCR.T, RCC_BDCR.Tp, 16#4002_3870#);
   ...
   package RCC_PLLI2SCFGR is
      ...
      package PLLI2SQ is new Bitfield (Tp, 24, 4);
      package PLLI2SN is new Bitfield (Tp, 6, 9);

      type T is
         record
            PLLI2SR : RCC_PLLI2SCFGR.PLLI2SR.T;
            PLLI2SQ : RCC_PLLI2SCFGR.PLLI2SQ.T;
      ...
      for T use
         record
            ...
            PLLI2SQ at 0 range PLLI2SQ.F .. PLLI2SQ.L;
   ...
   function PLLI2SQ is new PLLI2SCFGR.B (RCC_PLLI2SCFGR.PLLI2SQ) with Inline_Always;
   ...
   package RCC_PLLSAICFGR is

      package Tp is new Types (R32);

      package PLLSAIR is new Bitfield (Tp, 28, 3);
      package PLLSAIQ is new Bitfield (Tp, 24, 4);
      package PLLSAIN is new Bitfield (Tp, 6, 9);

      type T is
         record
            PLLSAIR : RCC_PLLSAICFGR.PLLSAIR.T;
            PLLSAIQ : RCC_PLLSAICFGR.PLLSAIQ.T;
            PLLSAIN : RCC_PLLSAICFGR.PLLSAIN.T;
         end record;

      for T use
         record
            PLLSAIR at 0 range PLLSAIR.F .. PLLSAIR.L;
            PLLSAIQ at 0 range PLLSAIQ.F .. PLLSAIQ.L;
            PLLSAIN at 0 range PLLSAIN.F .. PLLSAIN.L;
         end record;
   ...
   package PLLSAICFGR    is new Register (RCC_PLLSAICFGR.T, RCC_PLLSAICFGR.Tp, 16#4002_3888#);
   subtype PLLSAICFGR_T  is PLLSAICFGR.T;
   subtype PLLSAICFGR_F  is PLLSAICFGR.F;
   

   --  Field definitions

   function PLLSAIR is new PLLSAICFGR.B (RCC_PLLSAICFGR.PLLSAIR) with Inline_Always;
   function PLLSAIQ is new PLLSAICFGR.B (RCC_PLLSAICFGR.PLLSAIQ) with Inline_Always;
   function PLLSAIN is new PLLSAICFGR.B (RCC_PLLSAICFGR.PLLSAIN) with Inline_Always;

   --  Functions

   function "+"  is new PLLSAICFGR.Add      with Inline_Always;
   function "+"  is new PLLSAICFGR.Add_F    with Inline_Always;
   function "+"  is new PLLSAICFGR.Add_FF   with Inline_Always;
   function "-"  is new PLLSAICFGR.Clear    with Inline_Always;
   function "-"  is new PLLSAICFGR.Clear_FF with Inline_Always;
   function "="  is new PLLSAICFGR.Equal    with Inline_Always;
   function Init is new PLLSAICFGR.Init     with Inline_Always;

   ----------------------------------------------
   --  Dedicated Clock Configuration Register  --
   ----------------------------------------------

   package RCC_DCKCFGR is

      package Tp is new Types (R32);

      package TIMPRE     is new Bitfield (Tp, 24);
      package SAI1BSRC   is new Bitfield (Tp, 22, 2);
      package SAI1ASRC   is new Bitfield (Tp, 20, 2);
      package PLLSAIDIVR is new Bitfield (Tp, 16, 2);
      package PLLSAIDIVQ is new Bitfield (Tp, 8, 5);
      package PLLI2SDIVQ is new Bitfield (Tp, 0, 5);

      type T is
         record
            TIMPRE     : RCC_DCKCFGR.TIMPRE    .T;
            SAI1BSRC   : RCC_DCKCFGR.SAI1BSRC  .T;
            SAI1ASRC   : RCC_DCKCFGR.SAI1ASRC  .T;
            PLLSAIDIVR : RCC_DCKCFGR.PLLSAIDIVR.T;
            PLLSAIDIVQ : RCC_DCKCFGR.PLLSAIDIVQ.T;
            PLLI2SDIVQ : RCC_DCKCFGR.PLLI2SDIVQ.T;
         end record;

      for T use
         record
            TIMPRE     at 0 range TIMPRE    .F .. TIMPRE    .L;
            SAI1BSRC   at 0 range SAI1BSRC  .F .. SAI1BSRC  .L;
            SAI1ASRC   at 0 range SAI1ASRC  .F .. SAI1ASRC  .L;
            PLLSAIDIVR at 0 range PLLSAIDIVR.F .. PLLSAIDIVR.L;
            PLLSAIDIVQ at 0 range PLLSAIDIVQ.F .. PLLSAIDIVQ.L;
            PLLI2SDIVQ at 0 range PLLI2SDIVQ.F .. PLLI2SDIVQ.L;
         end record;
   ...
   package DCKCFGR    is new Register (RCC_DCKCFGR.T, RCC_DCKCFGR.Tp, 16#4002_388C#);
   subtype DCKCFGR_T  is DCKCFGR.T;
   subtype DCKCFGR_F  is DCKCFGR.F;
   

   --  Field definitions

   function TIMPRE     is new DCKCFGR.B (RCC_DCKCFGR.TIMPRE    ) with Inline_Always;
   function SAI1BSRC   is new DCKCFGR.B (RCC_DCKCFGR.SAI1BSRC  ) with Inline_Always;
   function SAI1ASRC   is new DCKCFGR.B (RCC_DCKCFGR.SAI1ASRC  ) with Inline_Always;
   function PLLSAIDIVR is new DCKCFGR.B (RCC_DCKCFGR.PLLSAIDIVR) with Inline_Always;
   function PLLSAIDIVQ is new DCKCFGR.B (RCC_DCKCFGR.PLLSAIDIVQ) with Inline_Always;
   function PLLI2SDIVQ is new DCKCFGR.B (RCC_DCKCFGR.PLLI2SDIVQ) with Inline_Always;

   --  Functions

   function "+"  is new DCKCFGR.Add      with Inline_Always;
   function "+"  is new DCKCFGR.Add_F    with Inline_Always;
   function "+"  is new DCKCFGR.Add_FF   with Inline_Always;
   function "-"  is new DCKCFGR.Clear    with Inline_Always;
   function "-"  is new DCKCFGR.Clear_FF with Inline_Always;
   function "="  is new DCKCFGR.Equal    with Inline_Always;
   function Init is new DCKCFGR.Init     with Inline_Always;

end ARM.Register.RCC_F42XXX;
