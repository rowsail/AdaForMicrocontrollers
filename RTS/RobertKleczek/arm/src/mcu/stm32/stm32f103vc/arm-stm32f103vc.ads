...
with ARM.Register.FLASH_F1XXXX;
with ARM.Register.RCC_F10XXX;
with ARM.Register.PWR_F10XXX;
...
package ARM.STM32F103VC is
   ...
   package FLASH renames ARM.Register.FLASH_F1XXXX;
   package RCC   renames ARM.Register.RCC_F10XXX;
   package PWR   renames ARM.Register.PWR_F10XXX;
