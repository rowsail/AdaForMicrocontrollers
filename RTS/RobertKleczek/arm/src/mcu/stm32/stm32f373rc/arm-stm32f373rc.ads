...
with ARM.Register.FLASH_F37XXX;
with ARM.Register.RCC_F37XXX;
with ARM.Register.PWR_F37XXX;
...
package ARM.STM32F373RC is
   ...
   package FLASH renames ARM.Register.FLASH_F37XXX;
   package RCC   renames ARM.Register.RCC_F37XXX;
   package PWR   renames ARM.Register.PWR_F37XXX;
